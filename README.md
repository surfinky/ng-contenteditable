...
The original and rather nifty set AngularJS components which allow arbitrary editing of specific content areas of a web page, inline and on the fly! Complete with dynamic drag and drop and two way wiring for roll-your-own GUI implementation.
